...
st.markdown("""<h1 style='text-align: center; white;font-size:60px;margin-top:-50x;'>APP ANALYTICS</h1><h1 style='text-align: center; color: white;font-size:30px;margin-top:-30px;'>Research Project<br></h1>""", unsafe_allow_html=True)
...
# app_name = 'tiktok'
# apple = AppleUsers_review(app_name)
# st.write(apple)
...
if Options == "App Analytics":
    ...
    if category_name == 'Analyze All Category':
        ...
        st.write("###### This plot shows where apps are downloaded mostly across all category between free and paid apps")
        st.pyplot(appType(df))
        st.write('')

        st.write("###### This plot shows weekly trend for the most downloaded category")
